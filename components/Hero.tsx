  ...
  return (
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* Deze zijn belangrijk omdat witte tekst anders moeilijk te lezen is op een lichte foto */}
      ...
      <div className="relative z-10 text-center px-4 max-w-6xl mx-auto mt-10">
        ...
        <div className="mb-8 flex justify-center">
            <img 
                src={haetechLogo} 
                alt="Haetech Logo" 
                className="w-48 md:w-72 h-auto object-contain drop-shadow-[0_0_15px_rgba(255,255,255,0.15)] transition-transform duration-700 hover:scale-105"
            />
        </div>
